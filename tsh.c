...
{
    //################### Variables ######################//
    int useBackgroundJob; // Will be 1 if user has requesteed a background job
    ...
    useBackgroundJob = parseline(cmdline, argv); // Will be 1 if user has requested a BG job
